...
class RegisterViewModel @Inject constructor(
    ...
    private val nameHasError = MutableStateFlow(true)
            ...
            uiStatusEventBus.setUiStatus(
                when(it) {
                    ...
                    is NetworkResult.Error -> {
                        authEventBus.setLoginPage(true)
                        UiStatus.ShowMessage(
                            UiMessage.ResourceMessage(
                                R.string.need_login_message
                            )
                        )
                    }
                }
    ...
    fun setNameHasError(isError: Boolean) {
        viewModelScope.launch(ioDispatcher) {
            nameHasError.value = isError
        }
    }
